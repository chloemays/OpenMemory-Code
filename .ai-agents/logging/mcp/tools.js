 ...
 * MCP Tool Handlers
 */
export async function handleLoggingTracingTool(name, args) {
    try {
        switch (name) {
            // LOGGING TOOLS
            case 'log_event':
            ...
            case 'search_logs':
                ...
                if (args.query)
                    logParams.append('query', args.query);
                if (args.category)
                    logParams.append('category', args.category);
                if (args.level)
                    logParams.append('level', args.level);
                if (args.limit)
                    logParams.append('limit', args.limit.toString());
            ...
            case 'search_traces':
                ...
                if (args.query)
                    traceParams.append('query', args.query);
                if (args.file)
                    traceParams.append('file', args.file);
                if (args.minDuration)
                    traceParams.append('minDuration', args.minDuration.toString());
                if (args.maxDuration)
                    traceParams.append('maxDuration', args.maxDuration.toString());
                if (args.hasError !== undefined)
                    traceParams.append('hasError', args.hasError.toString());
                if (args.limit)
                    traceParams.append('limit', args.limit.toString());
            ...
            case 'find_slow_executions':
                ...
                if (args.threshold)
                    slowParams.append('threshold', args.threshold.toString());
                if (args.limit)
                    slowParams.append('limit', args.limit.toString());
                return await apiCall('GET', `/api/tracing/slow?${slowParams}`);
            case 'find_errors':
                const errorParams = new URLSearchParams();
                if (args.limit)
                    errorParams.append('limit', args.limit.toString());
            ...
            case 'get_hotspots':
                ...
                if (args.limit)
                    hotspotParams.append('limit', args.limit.toString());
            ...
            case 'check_file_logging':
                ...
                const fileInfo = allFiles.files.find((f) => f.file === args.file);
                return {
                    file: args.file,
            ...
            case 'get_file_functions':
                ...
                const targetFile = filesData.files.find((f) => f.file === args.file);
                return {
                    file: args.file,
